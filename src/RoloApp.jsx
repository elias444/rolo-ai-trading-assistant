...
function RoloApp() {
  ...
  const fetchOptionsData = async (symbol, expiration) => {
    ...
    await fetchData(`/.netlify/functions/options-data?symbol=${symbol}&expiration=${formattedExpiration}`, (data) => setOptionsData(prev => ({ ...prev, [`${symbol}-${formattedExpiration}`]: data })), setIsLoadingOptions);
  };
      ...
      <main className="app-content">
        ...
        {activeTab === 'ticker' && (
          <div className="tab-content">
            ...
            <div className="input-group">
              <input type="text" placeholder="Enter stock symbol (e.g., AAPL)" value={currentTicker} onChange={(e) => setCurrentTicker(e.target.value.toUpperCase())} onKeyPress={(e) => { if (e.key === 'Enter') fetchStockData(currentTicker); }} />
              <button onClick={() => fetchStockData(currentTicker)}>Get Stock Data</button>
            </div>
            {isLoadingStock ? <p>Loading stock data...</p> : (
        ...
        {activeTab === 'market' && (
          <div className="tab-content">
            ...
            {isLoadingMarket ? <p>Loading market data...</p> : (
        ...
        {activeTab === 'options' && (
          <div className="tab-content">
            ...
            {isLoadingOptions ? <p>Loading options data...</p> : (
        ...
        {activeTab === 'chat' && (
          <div className="tab-content chat-tab">
            ...
            <div className="chat-input-group">
              <input type="text" placeholder="Ask Rolo a question..." value={chatInput} onChange={(e) => setChatInput(e.target.value)} onKeyPress={(e) => { if (e.key === 'Enter') handleSendMessage(); }} />
